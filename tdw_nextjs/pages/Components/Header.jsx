...
const Header = ({ companydata ,context}) => {
  const compName =
                  ...
                  <div className="ps-logo">
                    <div className="dflt_logo d-flex justify-content-center align-items-center">
                      <div className="cmpny_logo d-flex justify-content-center align-items-center">
                        <img
                          src="https://5.imimg.com/data5/SELLER/Logo/2025/1/477851711/CD/RR/AT/2003749/logo-experiment-tradeseal-05-90x90.jpg"
                          alt={compName}
                        />
                      </div>
                        ...
                        <div className="d-flex align-items-center loc_gst mt5">
                          <p className="d-flex align-items-center fs14">
                            <svg width="13" height="17" viewBox="0 0 13 17">
                              <path
                                d="M12.7892 6.32762C12.6144 3.20445 9.93954 0.646596 6.6974 0.504212..."
                                fill="#006061"
                              ></path>
                            </svg>
                          ...
                          <p className="d-flex align-items-center fs14">
                            <svg width="17" height="17" viewBox="0 0 17 17">
                              <path
                                d="M8.71665 0.5C4.34439 0.5 0.799988 4.08172..."
                                fill="#006061"
                              ></path>
                            </svg>
                            <span>
