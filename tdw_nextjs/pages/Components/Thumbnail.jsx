    ...
    return (
        <div className="col-md-6">
            <div className="position-sticky">
                ...
                <div div className="pdp_thmb mt15 position-relative" id="thumbnail-container37">
                    <div className="overflow-hidden t_nail"><ul className="d-flex align-items-center">
                        {multipleImages.map((simages, i) => {
                            let bImg = simages?.b_img_1000 ? simages.b_img_1000 : simages.b_img;
                            if (!bImg) {
                                bImg = simages?.s_img || "";
                            }
                                ...
                                return (
                                    <li key={i} className="d-flex align-items-center overflow-hidden cp pdp_vdo t_nl">
                                        <img
                                            ...
                                            data-img={`https://i.ytimg.com/vi/${productVideoCode}/default.jpg`}
                                            alt="Foil Print"
